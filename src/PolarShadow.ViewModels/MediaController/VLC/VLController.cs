...
namespace PolarShadow.VLC
{
    internal class VLController : ObservableObject, IVLController
    {
        ...
        public TimeSpan Length
        {
            ...
            private set
            {
                if (DispatcherUI.UI.CheckAccess())
                {
                    SetProperty(ref _length, value);
                }
                else
                {
                    DispatcherUI.UI.Post(()=> SetProperty(ref _length, value));
                }
            }
        }
        ...
        public TimeSpan Time
        {
            ...
            set
            {
                ...
                {
                    DispatcherUI.UI.Post(()=> SetProperty(ref _time, value));
                }
            }
        }
        ...
        public bool IsPlaying
        {
            ...
            set
            {
                ...
                {
                    DispatcherUI.UI.Post(() => SetProperty(ref _isPlaying, value));
                }
            }
        }
