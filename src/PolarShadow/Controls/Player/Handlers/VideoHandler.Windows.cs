...
{
    partial class VideoHandler : ViewHandler<VideoPlayer, PolarShadow.Platforms.Windows.VideoPlayer>
    {
        protected override Platforms.Windows.VideoPlayer CreatePlatformView()
        {
            return new Platforms.Windows.VideoPlayer(VirtualView);
        }

        protected override void ConnectHandler(Platforms.Windows.VideoPlayer platformView)
        {
            base.ConnectHandler(platformView);
            // Perform any control setup here
        }

        protected override void DisconnectHandler(PolarShadow.Platforms.Windows.VideoPlayer platformView)
        {
